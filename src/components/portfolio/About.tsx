    ...
    <section id="about" className="py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-5">
        <SectionHeading
          ...
          description="Final-year Sociology student at Ain Shams University with practical experience spanning sales, account management, marketing, public relations and business development. My career has been built around one core strength: understanding people, building trust and creating opportunities for growth. Having worked across multiple industries, I bring a combination of commercial awareness, communication skills and customer-focused execution."
        />
