    ...
    <section id="experience" className="bg-surface-dark text-[color:var(--surface-dark-foreground)] py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-5">
        <SectionHeading
          ...
          description="A diverse career journey across sales, marketing, client management, public relations and data operations. Each role strengthened my ability to understand customers, communicate value and contribute to business growth."
        />
